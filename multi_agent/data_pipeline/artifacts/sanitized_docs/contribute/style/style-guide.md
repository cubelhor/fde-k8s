...
[If you're localizing this page, you can omit the point about US English.]
...
Many existing pages still use the legacy ``, ``,
and `` shortcodes. These still work — prefer the `alert`
