...
> **Note:** Use this shortcode sparingly; it is usually best to have all of the text directly shown
to readers.
...
> **Note:** In previously released documentation, `latest` and `version` parameter values
