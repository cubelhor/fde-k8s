...
> **Note:** The feature can be enabled on nodes with the version 1.28. The behavior of built-in sidecar
...
> **Note:** Mutating webhook may update Pods based on some conditions.
