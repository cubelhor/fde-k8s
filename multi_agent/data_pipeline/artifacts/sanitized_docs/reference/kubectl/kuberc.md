 ...
 *(Feature State: beta as of v1.35)*
...
> **Note:** For a set of requirements to be valid it **must** have at least one field that is
...
> **Note:** While kuberc is in beta, `name` may be used as an alias for `command` in
...
> **Caution:** If you are using a managed Kubernetes provider, check your provider's
