...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>subsets</code><br/><em><a href="https://kubernetes.io/docs/#EndpointSubset">EndpointSubset array</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="https://kubernetes.io/docs/endpoints-v1#Endpoints">Endpoints array</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The IP of this endpoint. May not be loopback (127.0.0.0/8 or ::1), link-local (169.254.0.0/16 or fe80::/10), or link-local multicast (224.0.0.0/24 or ff02::/16).</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>targetRef</code><br/><em><a href="https://kubernetes.io/docs/../definitions/object-reference-v1#ObjectReference">ObjectReference</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The name of this port.  This must match the 'name' field in the corresponding ServicePort. Must be a DNS_LABEL. Optional only if one port is defined.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>The IP protocol for this port. Must be UDP, TCP, or SCTP. Default is TCP.<br/><br/>Possible enum values:<br/> - `"SCTP"` is the SCTP protocol.<br/> - `"TCP"` is the TCP protocol.<br/> - `"UDP"` is the UDP protocol.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>addresses</code><br/><em><a href="https://kubernetes.io/docs/#EndpointAddress">EndpointAddress array</a></em></td>
    ...
    <tr>
      <td><code>notReadyAddresses</code><br/><em><a href="https://kubernetes.io/docs/#EndpointAddress">EndpointAddress array</a></em></td>
    ...
    <tr>
      <td><code>ports</code><br/><em><a href="https://kubernetes.io/docs/#EndpointPort">EndpointPort array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="https://kubernetes.io/docs/endpoints-v1#Endpoints">Endpoints</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="https://kubernetes.io/docs/endpoints-v1#EndpointsList">EndpointsList</a></em></td>
    </tr>
  </tbody>
</table>
