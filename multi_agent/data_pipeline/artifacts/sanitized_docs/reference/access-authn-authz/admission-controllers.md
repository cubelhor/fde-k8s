 ...
 *(Feature State: deprecated as of v1.13)*
 ...
 *(Feature State: alpha as of v1.13)*
...
> **Note:** The webhook API objects are subject to the same versioning compatibility rules
...
> **Note:** `ImageReview` objects will include all images in Pods intended to be executed as
 ...
 *(Feature State: alpha as of v1.5)*
 ...
 *(Feature State: alpha as of v1.7)*
...
> **Note:** If any mutating admission webhook adds or modifies labels of the `pods/binding` subresource,
