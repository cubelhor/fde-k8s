...
> **Note:** Impersonating a user or group allows you to perform any action as if you were that user or group;
...
> **Note:** The `impersonate:associated-node` verb only applies when the impersonator is a service account bound to the
