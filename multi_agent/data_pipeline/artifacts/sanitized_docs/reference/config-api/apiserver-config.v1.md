...
Use '<em>.' to encrypt all resources within a group or '</em>.<em>' to encrypt all resources.
...
(3) --oidc-username-prefix=&quot;&quot;. For the same behavior using authentication config, set username.prefix=&quot;&quot;</p>
</td>
</tr>
...
Use '<em>.</em>' to encrypt all resources and '<em>.' to encrypt all resources in a specific group.
