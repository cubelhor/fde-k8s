...
See the [NetworkPolicy](/docs/reference/generated/kubernetes-api//#networkpolicy-v1-networking-k8s-io)
reference for a full definition of the resource.

An example NetworkPolicy might look like this:

> **Note:** POSTing this to the API server for your cluster will have no effect unless your chosen networking
...
> **Caution:** A default deny-all egress policy also blocks DNS traffic. If your workloads need DNS
...
> **Note:** You must be using a CNI plugin that supports SCTP
...
> **Note:** It is not possible to directly specify the name of the namespaces in a NetworkPolicy.
...
> **Note:** The following applies to clusters with a conformant networking plugin and a conformant implementation of
NetworkPolicy.
