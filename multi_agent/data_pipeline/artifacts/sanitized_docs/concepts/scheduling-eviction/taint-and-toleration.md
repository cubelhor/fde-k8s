...
> **Note:** When you create a Pod that uses `Gt` or `Lt` tolerations operators, the API server validates that
...
> **Note:** When using numeric comparison operators:
...
> **Warning:** Before disabling the `TaintTolerationComparisonOperators` feature gate:
...
> **Note:** The node controller was responsible for adding taints to nodes and evicting pods. But after 1.29,
