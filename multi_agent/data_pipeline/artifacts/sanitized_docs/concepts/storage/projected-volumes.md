...
> **Note:** Most applications should prefer using `credentialBundlePath` unless they need
...
> **Note:** In general, granting the container access to the host is discouraged as it can
