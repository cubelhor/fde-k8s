...
> **Warning:** Directly editing the size of a PersistentVolume can prevent an automatic resize of that volume.
...
: the volume can be mounted as read-write by many nodes.
 ...
 `ReadWriteOncePod`
:  *(Feature State: stable as of v1.29)*
...
> **Note:** Kubernetes uses volume access modes to match PersistentVolumeClaims and PersistentVolumes.
...
> **Note:** For most volume types, you do not need to set this field.
...
> **Note:** For `Filesystem` volumes, the storage request refers to the "outer" volume size
...
> **Note:** The unused duration indicated by this condition may be shorter than the actual
