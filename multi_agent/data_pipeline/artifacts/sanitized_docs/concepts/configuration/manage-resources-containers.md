...
> **Note:** Kubernetes doesn't allow you to specify CPU resources with a precision finer than
...
> **Note:** In-place resize currently applies to container-level resources. For resizing Pod-level
...
> **Caution:** If you do not specify a `sizeLimit` for an `emptyDir` volume, that volume may
