...
> **Caution:** It's important to note that the default location `/var/log/pods` has been in use for
...
> **Note:** If you deploy Kubernetes cluster components (such as the scheduler) to log to
