...
> **Note:** The processing of the fully-qualified CDI device names by the Device Manager requires
...
in the plugin's [PodSpec](/docs/reference/generated/kubernetes-api//#podspec-v1-core).
...
> **Note:** cpu_ids in the `ContainerResources` in the `List` endpoint correspond to exclusive CPUs allocated
...
> **Note:** `GetAllocatableResources` should only be used to evaluate [allocatable](/docs/tasks/administer-cluster/reserve-compute-resources/#node-allocatable)
...
[PodSpec](/docs/reference/generated/kubernetes-api//#podspec-v1-core).

> **Note:** When accessing the `pod-resources/kubelet.sock` from DaemonSet
