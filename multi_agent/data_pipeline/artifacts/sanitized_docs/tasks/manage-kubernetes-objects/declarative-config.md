...
> **Warning:** Take care when using `--prune` with `kubectl apply` in allow list mode. Which
...
> **Caution:** `kubectl apply --prune --applyset` is in alpha, and backwards incompatible
...
> **Caution:** A *patch* is an update operation that is scoped to specific fields of an object
...
* [Kubernetes API Reference](/docs/reference/generated/kubernetes-api//)