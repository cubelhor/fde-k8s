...
[Kubernetes API documentation](/docs/reference/generated/kubernetes-api//#deploymentspec-v1-apps).
...
> **Note:** If you run `kubectl patch` and specify `--subresource` flag for resource that doesn't support that
