...
1. Update the `--root-ca-file` flag for the kube-controller-manager to include
...
1. Update the `--root-ca-file` flag for the cloud-controller-manager to include
...
> **Note:** To generate certificates and private keys for your cluster using the `openssl` command line tool,
