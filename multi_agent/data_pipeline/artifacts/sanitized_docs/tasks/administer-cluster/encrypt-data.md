...
> **Caution:** If any resource is not readable via the encryption configuration (because keys were changed),
...
> **Caution:** Storing the raw encryption key in the EncryptionConfig only moderately improves your security posture,
...
> **Note:** Keep the encryption key confidential, including while you generate it and
...
> **Caution:** For cluster configurations with two or more control plane nodes, the encryption configuration
...
> **Warning:** Making this change prevents the API server from retrieving resources that are marked
