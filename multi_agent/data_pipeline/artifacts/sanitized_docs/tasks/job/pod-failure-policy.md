...
> **Note:** The example below works since version 1.27 as it relies on transitioning of
...
> **Note:** In a production environment, the steps 3 and 4 should be automated by a
