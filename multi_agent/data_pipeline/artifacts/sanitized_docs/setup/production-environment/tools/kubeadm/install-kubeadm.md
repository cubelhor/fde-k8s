...
> **Note:** Docker Engine does not implement the [CRI](/docs/concepts/architecture/cri/)
...
> **Note:** There's a dedicated package repository for each Kubernetes minor version. If you want to install
...
> **Note:** Please refer to the note in the [Before you begin](#before-you-begin) section for Linux distributions
