 ...
 *(Feature State: beta as of v1.22)*

Alternatively, you can use the `skipPhases` field under `InitConfiguration`.

### Using kubeadm init with a configuration file {#config-file}

> **Caution:** The configuration file is still considered beta and may change in future versions.
...
> **Note:** A predefined `certificateKey` can be provided in `InitConfiguration` when passing the
