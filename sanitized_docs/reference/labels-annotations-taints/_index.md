...
> **Note:** This annotation is currently deprecated and replaced by [`applyset.kubernetes.io/contains-group-kinds`](#applyset-kubernetes-io-contains-group-kinds),
...
> **Note:** Automanaged APIService objects are deleted by kube-apiserver when it has no built-in
...
> **Note:** `kubernetes.io/enforce-mountable-secrets` is deprecated since Kubernetes v1.32. Use separate namespaces to isolate access to mounted secrets.
...
> **Note:** This label is deprecated and has no effect in current Kubernetes versions.
...
> **Note:** Ingress traffic shaping annotation is an experimental feature.
...
> **Note:** Egress traffic shaping annotation is an experimental feature.
If you want to enable traffic shaping support, you must add the `bandwidth` plugin to your CNI
configuration file (default `/etc/cni/net.d`) and ensure that the binary is included in your CNI
bin dir (default `/opt/cni/bin`).
...
> **Note:** The [Endpoints](/docs/reference/kubernetes-api/service-resources/endpoints-v1/)
...
> **Note:** Starting from v1.20, this annotation is deprecated.
...
> **Note:** This annotation is deprecated. You should use the
...
> **Note:** Starting from Kubernetes 1.27, this label is deprecated.
...
> **Caution:** Refer to [Non-graceful node shutdown](/docs/concepts/cluster-administration/node-shutdown/#non-graceful-node-shutdown)
...
> **Note:** These Node Feature Discovery (NFD) labels or annotations only apply to 
...
> **Caution:** Do not modify or add the `service.beta.kubernetes.io/aws-load-balancer-type` annotation
...
> **Note:** Starting in v1.16, this annotation was removed in favor of
...
> **Note:** Starting from v1.34, this annotation is deprecated, kubeadm will no longer actively set and use it.
