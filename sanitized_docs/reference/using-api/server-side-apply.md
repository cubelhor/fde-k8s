...
> **Note:** `kubectl get` omits managed fields by default.
...
> **Caution:** The `.metadata.managedFields` field is managed by the API server.
...
> **Caution:** Keep the `last-applied-configuration` annotation up to date.
