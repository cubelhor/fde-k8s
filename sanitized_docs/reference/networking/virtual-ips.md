 ...
 *(Feature State: deprecated as of v1.35)*
...
> **Note:** The `ipvs` proxy mode was an experiment in providing a Linux
...
> **Note:** To run kube-proxy in IPVS mode, you must make IPVS available on
