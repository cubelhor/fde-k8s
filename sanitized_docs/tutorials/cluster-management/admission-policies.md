# Explore Validating and Mutating Admission Policies
...
> **Caution:** Anyone with full / admin access to a namespace can write to its labels. This includes deleting a label from
the namespace.
...
> **Note:** If you did change the ValidatingAdmissionPolicyBinding to just warn people, there's a problem&hellip;
...
> **Caution:** This policy sets a **default**. Someone with the ability to update a Namespace would be able to remove the
