...
> **Note:** * You must [create a ConfigMap](/docs/tasks/configure-pod-container/configure-pod-configmap/#create-a-configmap)
...
> **Note:** A container using the downward API as a [`subPath`](#using-subpath) volume mount does not
...
> **Caution:** Please check [here](/docs/concepts/configuration/manage-resources-containers/#memory-backed-emptydir)
...
> **Note:** You must configure FC SAN Zoning to allocate and mask those LUNs (volumes) to the target WWNs
...
> **Warning:** Kubernetes  does *not* include the `gitRepo` volume
...
> **Caution:** The `FileOrCreate` mode does **not** create the parent directory of the file. If the parent directory
 ...
 *(Feature State: deprecated as of v1.25)*
...
> **Note:** Make sure you have an existing PortworxVolume with the name `pxvol`
...
> **Note:** Support for CSI spec versions 0.2 and 0.3 is deprecated in Kubernetes
 ...
 *(Feature State: stable as of v1.22)*
...
> **Note:** Existing PVs created by an in-tree volume plugin can still be used in the future without any configuration
 ...
 *(Feature State: deprecated as of v1.23)*
...
> **Caution:** Mount propagation is a low-level feature that does not work consistently on all
...
> **Warning:** `Bidirectional` mount propagation can be dangerous. It can damage
