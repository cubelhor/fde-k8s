...
> **Note:** The `<unknown>` value indicates that the `.status.nodeInfo.swap.capacity` field is not set for that Node.
...
> **Caution:** It is deeply encouraged to encrypt the swap space.
