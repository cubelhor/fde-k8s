 ...
 *(Feature State: beta as of v1.23)*
 ...
 *(Feature State: beta as of v1.30)*
 ...
 *(Feature State: alpha as of v1.19)*

> **Warning:** JSON output does not support many standard klog flags. For list of unsupported klog flags, see the
...
> **Warning:** Granting permissions to `nodes/proxy` (even just **get** permission) also
