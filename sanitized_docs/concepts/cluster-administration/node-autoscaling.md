...
Nodes. Nodes in your cluster can be _autoscaled_ -
...
> **Note:** Correctly setting the resource requests of your Pods is as important to the overall
...
> **Note:** Autoscalers predict how a recreated Pod will likely be scheduled after a Node is provisioned or
...
> **Note:** Consolidation was formerly known as _scale-down_ in Cluster Autoscaler.
