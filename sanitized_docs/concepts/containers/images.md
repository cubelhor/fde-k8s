...
> **Note:** You should avoid using the `:latest` tag when deploying containers in production as
...
> **Note:** The value of `imagePullPolicy` of the container is always set when the object is
 ...
 *(Feature State: stable as of v1.35)*
...
> **Note:** In the case of credential rotation, the credentials previously used to pull the image
