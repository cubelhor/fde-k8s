...
> **Warning:** The validation rules published as part of OpenAPI schemas may not be complete, and usually aren't.
...
> **Note:** Although Kubernetes also aims to maintain compatibility for _alpha_ APIs versions, in some
