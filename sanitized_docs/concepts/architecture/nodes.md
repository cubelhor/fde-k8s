...
> **Note:** As mentioned in the [Node name uniqueness](#node-name-uniqueness) section,
...
> **Note:** Pods that are part of a daemonset tolerate
...
> **Note:** If you want to explicitly reserve resources for non-Pod processes, see
...
* [API definition for Node](/docs/reference/generated/kubernetes-api//#node-v1-core).
