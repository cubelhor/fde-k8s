...
> **Note:** You should only create a ServiceAccount token Secret
...
[`Pod`](/docs/reference/generated/kubernetes-api//#pod-v1-core)
...
See the [PodSpec API](/docs/reference/generated/kubernetes-api//#podspec-v1-core)
...
> **Note:** Once a Secret or ConfigMap is marked as immutable, it is _not_ possible to revert this change
