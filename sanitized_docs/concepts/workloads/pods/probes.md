...
> **Caution:** Incorrect implementation of readiness probes may result in an ever growing
...
> **Caution:** When processing an `httpGet` probe, the kubelet stops reading the response body after 10KiB.
...
> **Note:** Unlike HTTP or TCP probes, you cannot specify the health check port by name,
