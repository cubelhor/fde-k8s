...
> **Note:** In `apiextensions.k8s.io/v1beta1`, there was a `version` field instead of `versions`. The
...
> **Note:** Here is an example of how to patch the `status` subresource for a CRD object using `kubectl`:
```bash
