...
> **Note:** Versions of Kubernetes before v1.22 automatically created long term credentials for
...
> **Note:** The content of `token` is omitted here.
...
> **Note:** If you view the ServiceAccount using:
