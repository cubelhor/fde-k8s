...
> **Note:** * `kubectl debug` automatically generates a container name if you don't choose
...
> **Note:** * To change the command of a specific container you must
...
> **Note:** Don't forget to clean up the debugging Pod when you're finished with it:
...
> **Note:** If you don't specify `--profile`, the `legacy` profile is used by default, but it is planned to be deprecated in the near future.
 ...
 *(Feature State: stable as of v1.32)*
...
> **Note:** Custom profile only supports the modification of the container spec, 
