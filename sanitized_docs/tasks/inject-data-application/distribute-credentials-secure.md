...
> **Note:** Special characters such as `$`, `\`, `*`, `=`, and `!` will be interpreted by your
...
> **Note:** How the specs for the two Pods differ only in one field; this facilitates creating Pods
...
- [Volume](/docs/reference/generated/kubernetes-api//#volume-v1-core)
