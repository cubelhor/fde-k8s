...
> **Note:** If the Topology Manager is configured with the **pod** scope, the container, which is considered by
...
> **Note:** If you select the `max-allowable-numa-nodes` policy option, nodes with more than 8 NUMA nodes can
