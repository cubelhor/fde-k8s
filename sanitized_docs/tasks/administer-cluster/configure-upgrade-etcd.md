...
> **Note:** etcd authentication is not planned for Kubernetes.
...
> **Note:** The usage of `etcdctl snapshot status` has been **deprecated** since etcd v3.5.x and is slated for removal from etcd v3.6.
...
> **Caution:** If any API servers are running in your cluster, you should not attempt to
...
> **Note:** The usage of `etcdctl` for restoring has been **deprecated** since etcd v3.5.x and is slated for removal from etcd v3.6.
   It is recommended to utilize [`etcdutl`](https://github.com/etcd-io/etcd/blob/main/etcdutl/README.md) instead.
...
> **Caution:** Before you start an upgrade, back up your etcd cluster first.
