...
> **Note:** In kubeadm clusters, verify all relevant locations where feature gates might be 
...
> **Caution:** When a feature requires multiple components, you must enable the gate on all relevant 
