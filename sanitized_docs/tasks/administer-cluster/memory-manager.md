...
Set the `memoryManagerPolicy` configuration field within the [kubelet configuration](https://kubernetes.io/docs/docs/reference/config-api/kubelet-config.v1beta1), to the name of your chosen [policy](#policies).
