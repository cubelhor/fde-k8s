...
[main Kubernetes blog](/docs/contribute/blog/), we (the Kubernetes project) like
...
1. Your writing buddy can review your submission and work with you on feedback
...
- we avoid using Kubernetes shortcodes for callouts (such as
  ``). This is because callouts are aimed at documentation
...
- code samples used in blog articles don't need to use the
  `` shortcode, and often it is better (easier to
