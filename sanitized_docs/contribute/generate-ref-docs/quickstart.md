...
> **Note:** If you want to change the content of the component tools and API reference,
...
> **Note:** The [`kubelet` reference page](/docs/reference/command-line-tools-reference/kubelet/) is not generated by this script and is maintained manually.
...
> **Note:** The `generate-command` is an optional entry, which can be used to run a
...
static/docs/reference/generated/kubernetes-api//js/query.scrollTo.min.js
