...
PROJECT_ID = os.getenv("GOOGLE_CLOUD_PROJECT", "smiling-foundry-484209-u0")
...
LOCAL_JSONL_PATH = "fde-k8s/k8s_chunks_custom.jsonl"
...
def get_authenticated_clients():
    try:
        ...
        print("\nPlease run the following command to reauthenticate:")
